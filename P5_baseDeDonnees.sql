...
INSERT INTO blog
SET titre="Naissance d'un développeur", auteur="Jessy BROS", chapo="Comment est-il devenu développeur avec Openclassrooms !", contenu="C'est l'histoire d'un jeune policier, reconvertis en développeur web. <br> Il découvrit par hasard des cours de développement. Il étudia et essaya ! Après avoir réussi le parcours de développeur web à l'aide d'un super mentor, il décida de poursuivre sa route et devint un développeur web. Merci !",
...
INSERT INTO blog
SET titre="L'association Astree", auteur="Jessy BROS", chapo="On ne peut qu'apprecier !", contenu="Comme vous l'aurez compris, cette fois-là, j'ai développé pour une petite grande association. Un mailing. <br> C'est l'un de mes tout premiers clients, et de temps en temps je suis là pour répondre à leurs besoins. <br> Travailler pour des projets qui vous tiennent à coeur, qui vous plaisent et amusez-vous ! Enfin restons tout de même profesionnel ! :)",
...
INSERT INTO blog
SET titre="Numero 10 media", auteur="Jessy BROS", chapo=" Qui sont-ils ?", contenu="Non ce n'est pas le dixième média les plus connus. Mais une simple agence marketing qui a fait appel à mes services pour un petite OnePage sur WordPress.  <br> C'est un projet que j'ai particulièrement adoré réaliser. Ils étaient investis et la maquette qu'ils détenaient était un petit challenge et surtout très appréciable visuellement ! Fier du résultat est d'avoir pu contribuer à ce magnifique projet ! :)",
...
INSERT INTO blog
SET titre="Les Films de Plein Air", auteur="Jessy BROS", chapo="Une fête ! Où çà ?", contenu="Oui les amis, je viens de réaliser un projet mouvementé ! Attention, vous êtes tous invités ! Petite soirée du 5 au 8 août, on se pose devant des films dans une ambiance de folie ! <br> Je vous promets deux choses ! Que les préinscriptions sont fonctionnels  ahah! La deuxième ? On va s'amusez comme des fous ! <br> Alors venez nombreux ! :O",
