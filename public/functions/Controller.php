...
class Controller
{
    ...
    public function accueil()
    {
        ...
        echo $this->twig->render('visiteur/accueil.twig',["lesDerniersBlogs" => $lesDerniersBlogs-> lesDerniersBlogs(),"messageServeur" => $messageServeur]);
    }
    ...
    public function nouveauMotDePasse()
    {
        ...
        $nouveauMotDePasseManager = new Utilisateur;
        $verificationUtilisateurExistManager = new Utilisateur;
        require "public/functions/nouveauMotDePasse.php";
